...
## Contexto
Esta história detalha a capacidade **comparar resultado**.

## História de usuário
Como **gestor**, quero **comparar resultado**, para **compreender o trabalho e o valor gerado**.

## Critérios de aceitação
- [ ] A capacidade 'Comparar resultado' pode ser executada no fluxo previsto.
