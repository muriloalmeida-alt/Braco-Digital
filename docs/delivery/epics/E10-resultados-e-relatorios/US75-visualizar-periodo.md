...
## Contexto
Esta história detalha a capacidade **visualizar período**.

## História de usuário
Como **gestor**, quero **visualizar período**, para **compreender o trabalho e o valor gerado**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar período' pode ser executada no fluxo previsto.
