# US70 — Visualizar atendimentos

**Épico:** E10 — Resultados e Relatórios  
**Prioridade:** P1  
**Sprint planejada:** Sprint 06

## Contexto
Esta história detalha a capacidade **visualizar atendimentos**.

## História de usuário
Como **gestor**, quero **visualizar atendimentos**, para **compreender o trabalho e o valor gerado**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar atendimentos' pode ser executada no fluxo previsto.
...
## Regras de negócio
- Indicadores devem mostrar trabalho e resultado.
- Evitar métricas de vaidade.

## Dependências
- PRD aplicável.
- E10 — Resultados e Relatórios.
...
- `docs/delivery/epics/E10-resultados-e-relatorios/epic.md`
