...
## Contexto
Esta história detalha a capacidade **visualizar intervenções**.

## História de usuário
Como **gestor**, quero **visualizar intervenções**, para **compreender o trabalho e o valor gerado**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar intervenções' pode ser executada no fluxo previsto.
