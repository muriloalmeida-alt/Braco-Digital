...
## Contexto
Esta história detalha a capacidade **visualizar indicadores**.

## História de usuário
Como **gestor**, quero **visualizar indicadores**, para **compreender o trabalho e o valor gerado**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar indicadores' pode ser executada no fluxo previsto.
