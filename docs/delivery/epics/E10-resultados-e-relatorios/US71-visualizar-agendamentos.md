...
## Contexto
Esta história detalha a capacidade **visualizar agendamentos**.

## História de usuário
Como **gestor**, quero **visualizar agendamentos**, para **compreender o trabalho e o valor gerado**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar agendamentos' pode ser executada no fluxo previsto.
