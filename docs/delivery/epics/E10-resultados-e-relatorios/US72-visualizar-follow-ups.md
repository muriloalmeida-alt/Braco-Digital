...
## Contexto
Esta história detalha a capacidade **visualizar follow-ups**.

## História de usuário
Como **gestor**, quero **visualizar follow-ups**, para **compreender o trabalho e o valor gerado**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar follow-ups' pode ser executada no fluxo previsto.
