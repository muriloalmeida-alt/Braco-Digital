...
## Contexto
Esta história detalha a capacidade **informar dados da empresa**.

## História de usuário
Como **gestor**, quero **informar dados da empresa**, para **preparar o funcionário para trabalhar corretamente**.

## Critérios de aceitação
- [ ] A capacidade 'Informar dados da empresa' pode ser executada no fluxo previsto.
