...
## Contexto
Esta história detalha a capacidade **definir autonomia**.

## História de usuário
Como **gestor**, quero **definir autonomia**, para **preparar o funcionário para trabalhar corretamente**.

## Critérios de aceitação
- [ ] A capacidade 'Definir autonomia' pode ser executada no fluxo previsto.
