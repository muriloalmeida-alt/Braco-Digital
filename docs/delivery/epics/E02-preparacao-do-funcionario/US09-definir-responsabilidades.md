...
## Contexto
Esta história detalha a capacidade **definir responsabilidades**.

## História de usuário
Como **gestor**, quero **definir responsabilidades**, para **preparar o funcionário para trabalhar corretamente**.

## Critérios de aceitação
- [ ] A capacidade 'Definir responsabilidades' pode ser executada no fluxo previsto.
...
- Responsabilidades, limites e autonomia são conceitos distintos.
