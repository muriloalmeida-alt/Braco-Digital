...
## Contexto
Esta história detalha a capacidade **configurar recursos de trabalho**.

## História de usuário
Como **gestor**, quero **configurar recursos de trabalho**, para **preparar o funcionário para trabalhar corretamente**.

## Critérios de aceitação
- [ ] A capacidade 'Configurar recursos de trabalho' pode ser executada no fluxo previsto.
