...
## Contexto
Esta história detalha a capacidade **oferecer horários**.

## História de usuário
Como **funcionário digital**, quero **oferecer horários**, para **transformar atendimento em agendamento confiável**.

## Critérios de aceitação
- [ ] A capacidade 'Oferecer horários' pode ser executada no fluxo previsto.
