...
## Contexto
Esta história detalha a capacidade **cancelar agendamento**.

## História de usuário
Como **funcionário digital**, quero **cancelar agendamento**, para **transformar atendimento em agendamento confiável**.

## Critérios de aceitação
- [ ] A capacidade 'Cancelar agendamento' pode ser executada no fluxo previsto.
