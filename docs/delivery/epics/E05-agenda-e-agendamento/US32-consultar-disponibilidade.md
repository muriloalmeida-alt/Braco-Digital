# US32 — Consultar disponibilidade
...
## Contexto
Esta história detalha a capacidade **consultar disponibilidade**.

## História de usuário
Como **funcionário digital**, quero **consultar disponibilidade**, para **transformar atendimento em agendamento confiável**.

## Critérios de aceitação
- [ ] A capacidade 'Consultar disponibilidade' pode ser executada no fluxo previsto.
