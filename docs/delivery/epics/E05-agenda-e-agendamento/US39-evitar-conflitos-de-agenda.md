# US39 — Evitar conflitos de agenda
...
## Contexto
Esta história detalha a capacidade **evitar conflitos de agenda**.

## História de usuário
Como **funcionário digital**, quero **evitar conflitos de agenda**, para **transformar atendimento em agendamento confiável**.

## Critérios de aceitação
- [ ] A capacidade 'Evitar conflitos de agenda' pode ser executada no fluxo previsto.
