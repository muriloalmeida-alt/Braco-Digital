...
## Contexto
Esta história detalha a capacidade **alterar agendamento**.

## História de usuário
Como **funcionário digital**, quero **alterar agendamento**, para **transformar atendimento em agendamento confiável**.

## Critérios de aceitação
- [ ] A capacidade 'Alterar agendamento' pode ser executada no fluxo previsto.
