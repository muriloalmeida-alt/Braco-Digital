...
## Contexto
Esta história detalha a capacidade **encerrar atendimento**.

## História de usuário
Como **funcionário digital**, quero **encerrar atendimento**, para **atender clientes com fluidez e contexto**.

## Critérios de aceitação
- [ ] A capacidade 'Encerrar atendimento' pode ser executada no fluxo previsto.
