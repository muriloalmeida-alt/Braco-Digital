# US24 — Identificar funcionário no atendimento

**Épico:** E04 — Atendimento pelo WhatsApp  
**Prioridade:** P0  
**Sprint planejada:** Sprint 03

## Contexto
Esta história detalha a capacidade **identificar funcionário no atendimento**.

## História de usuário
Como **funcionário digital**, quero **identificar funcionário no atendimento**, para **atender clientes com fluidez e contexto**.

## Critérios de aceitação
- [ ] A capacidade 'Identificar funcionário no atendimento' pode ser executada no fluxo previsto.
...
## Regras de negócio
- O cliente conversa pelo WhatsApp.
- O funcionário se identifica como digital.
- Manter contexto e respeitar o Manual de Trabalho.

## Dependências
- PRD aplicável.
- E04 — Atendimento pelo WhatsApp.
...
- `docs/delivery/epics/E04-atendimento-pelo-whatsapp/epic.md`
