# US26 — Entender intenção do cliente
...
## Contexto
Esta história detalha a capacidade **entender intenção do cliente**.

## História de usuário
Como **funcionário digital**, quero **entender intenção do cliente**, para **atender clientes com fluidez e contexto**.

## Critérios de aceitação
- [ ] A capacidade 'Entender intenção do cliente' pode ser executada no fluxo previsto.
