...
## Contexto
Esta história detalha a capacidade **ativar funcionário**.

## História de usuário
Como **gestor**, quero **ativar funcionário**, para **controlar com segurança o ciclo de vida do funcionário**.

## Critérios de aceitação
- [ ] A capacidade 'Ativar funcionário' pode ser executada no fluxo previsto.
