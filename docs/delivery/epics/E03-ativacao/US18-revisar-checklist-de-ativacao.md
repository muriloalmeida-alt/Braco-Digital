# US18 — Revisar checklist de ativação
...
## Contexto
Esta história detalha a capacidade **revisar checklist de ativação**.

## História de usuário
Como **gestor**, quero **revisar checklist de ativação**, para **controlar com segurança o ciclo de vida do funcionário**.

## Critérios de aceitação
- [ ] A capacidade 'Revisar checklist de ativação' pode ser executada no fluxo previsto.
