...
## Contexto
Esta história detalha a capacidade **pausar funcionário**.

## História de usuário
Como **gestor**, quero **pausar funcionário**, para **controlar com segurança o ciclo de vida do funcionário**.

## Critérios de aceitação
- [ ] A capacidade 'Pausar funcionário' pode ser executada no fluxo previsto.
