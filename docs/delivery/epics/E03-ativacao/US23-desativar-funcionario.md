...
## Contexto
Esta história detalha a capacidade **desativar funcionário**.

## História de usuário
Como **gestor**, quero **desativar funcionário**, para **controlar com segurança o ciclo de vida do funcionário**.

## Critérios de aceitação
- [ ] A capacidade 'Desativar funcionário' pode ser executada no fluxo previsto.
