# US20 — Impedir ativação incompleta
...
## Contexto
Esta história detalha a capacidade **impedir ativação incompleta**.

## História de usuário
Como **gestor**, quero **impedir ativação incompleta**, para **controlar com segurança o ciclo de vida do funcionário**.

## Critérios de aceitação
- [ ] A capacidade 'Impedir ativação incompleta' pode ser executada no fluxo previsto.
