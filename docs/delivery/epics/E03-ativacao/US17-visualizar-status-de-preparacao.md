...
## Contexto
Esta história detalha a capacidade **visualizar status de preparação**.

## História de usuário
Como **gestor**, quero **visualizar status de preparação**, para **controlar com segurança o ciclo de vida do funcionário**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar status de preparação' pode ser executada no fluxo previsto.
