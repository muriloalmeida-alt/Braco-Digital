...
## Contexto
Esta história detalha a capacidade **preservar contexto**.

## História de usuário
Como **funcionário digital**, quero **preservar contexto**, para **encaminhar situações que exigem uma pessoa**.

## Critérios de aceitação
- [ ] A capacidade 'Preservar contexto' pode ser executada no fluxo previsto.
