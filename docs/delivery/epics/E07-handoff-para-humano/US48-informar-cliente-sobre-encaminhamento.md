# US48 — Informar cliente sobre encaminhamento
...
## Contexto
Esta história detalha a capacidade **informar cliente sobre encaminhamento**.

## História de usuário
Como **funcionário digital**, quero **informar cliente sobre encaminhamento**, para **encaminhar situações que exigem uma pessoa**.

## Critérios de aceitação
- [ ] A capacidade 'Informar cliente sobre encaminhamento' pode ser executada no fluxo previsto.
