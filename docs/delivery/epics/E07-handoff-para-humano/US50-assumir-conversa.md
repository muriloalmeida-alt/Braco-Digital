...
## Contexto
Esta história detalha a capacidade **assumir conversa**.

## História de usuário
Como **funcionário digital**, quero **assumir conversa**, para **encaminhar situações que exigem uma pessoa**.

## Critérios de aceitação
- [ ] A capacidade 'Assumir conversa' pode ser executada no fluxo previsto.
