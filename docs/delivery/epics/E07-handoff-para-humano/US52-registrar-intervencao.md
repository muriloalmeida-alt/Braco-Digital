...
## Contexto
Esta história detalha a capacidade **registrar intervenção**.

## História de usuário
Como **funcionário digital**, quero **registrar intervenção**, para **encaminhar situações que exigem uma pessoa**.

## Critérios de aceitação
- [ ] A capacidade 'Registrar intervenção' pode ser executada no fluxo previsto.
