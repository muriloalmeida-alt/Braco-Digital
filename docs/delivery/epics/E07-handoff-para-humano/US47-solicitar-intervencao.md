...
## Contexto
Esta história detalha a capacidade **solicitar intervenção**.

## História de usuário
Como **funcionário digital**, quero **solicitar intervenção**, para **encaminhar situações que exigem uma pessoa**.

## Critérios de aceitação
- [ ] A capacidade 'Solicitar intervenção' pode ser executada no fluxo previsto.
