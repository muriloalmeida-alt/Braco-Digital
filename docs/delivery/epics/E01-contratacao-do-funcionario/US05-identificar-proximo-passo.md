...
## Contexto
Esta história detalha a capacidade **identificar próximo passo**.

## História de usuário
Como **gestor**, quero **identificar próximo passo**, para **iniciar a contratação e entender o próximo passo**.

## Critérios de aceitação
- [ ] A capacidade 'Identificar próximo passo' pode ser executada no fluxo previsto.
