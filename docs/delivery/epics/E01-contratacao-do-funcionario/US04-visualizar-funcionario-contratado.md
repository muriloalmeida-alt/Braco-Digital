...
## Contexto
Esta história detalha a capacidade **visualizar funcionário contratado**.

## História de usuário
Como **gestor**, quero **visualizar funcionário contratado**, para **iniciar a contratação e entender o próximo passo**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar funcionário contratado' pode ser executada no fluxo previsto.
