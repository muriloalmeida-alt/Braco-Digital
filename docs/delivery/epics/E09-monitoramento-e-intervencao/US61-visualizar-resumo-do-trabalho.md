# US61 — Visualizar resumo do trabalho

**Épico:** E09 — Monitoramento e Intervenção  
**Prioridade:** P1  
**Sprint planejada:** Sprint 06

## Contexto
Esta história detalha a capacidade **visualizar resumo do trabalho**.

## História de usuário
Como **gestor**, quero **visualizar resumo do trabalho**, para **acompanhar a operação e agir quando necessário**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar resumo do trabalho' pode ser executada no fluxo previsto.
...
## Regras de negócio
- Seguir Resumo → Atenção → Ação → Detalhe.
- Alertas devem ser acionáveis.

## Dependências
- PRD aplicável.
- E09 — Monitoramento e Intervenção.
...
- `docs/delivery/epics/E09-monitoramento-e-intervencao/epic.md`
