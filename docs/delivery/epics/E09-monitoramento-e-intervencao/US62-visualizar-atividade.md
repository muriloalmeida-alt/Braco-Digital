...
## Contexto
Esta história detalha a capacidade **visualizar atividade**.

## História de usuário
Como **gestor**, quero **visualizar atividade**, para **acompanhar a operação e agir quando necessário**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar atividade' pode ser executada no fluxo previsto.
