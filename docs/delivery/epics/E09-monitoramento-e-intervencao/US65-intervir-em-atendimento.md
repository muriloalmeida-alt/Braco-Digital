...
## Contexto
Esta história detalha a capacidade **intervir em atendimento**.

## História de usuário
Como **gestor**, quero **intervir em atendimento**, para **acompanhar a operação e agir quando necessário**.

## Critérios de aceitação
- [ ] A capacidade 'Intervir em atendimento' pode ser executada no fluxo previsto.
