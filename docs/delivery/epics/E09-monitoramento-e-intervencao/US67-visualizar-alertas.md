...
## Contexto
Esta história detalha a capacidade **visualizar alertas**.

## História de usuário
Como **gestor**, quero **visualizar alertas**, para **acompanhar a operação e agir quando necessário**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar alertas' pode ser executada no fluxo previsto.
