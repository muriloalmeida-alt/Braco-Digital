...
## Contexto
Esta história detalha a capacidade **filtrar atendimentos**.

## História de usuário
Como **gestor**, quero **filtrar atendimentos**, para **acompanhar a operação e agir quando necessário**.

## Critérios de aceitação
- [ ] A capacidade 'Filtrar atendimentos' pode ser executada no fluxo previsto.
