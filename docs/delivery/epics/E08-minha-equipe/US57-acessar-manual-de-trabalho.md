...
## Contexto
Esta história detalha a capacidade **acessar manual de trabalho**.

## História de usuário
Como **gestor**, quero **acessar manual de trabalho**, para **administrar a equipe em um único lugar**.

## Critérios de aceitação
- [ ] A capacidade 'Acessar Manual de Trabalho' pode ser executada no fluxo previsto.
