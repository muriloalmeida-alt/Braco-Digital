...
## Contexto
Esta história detalha a capacidade **pausar e retomar pela equipe**.

## História de usuário
Como **gestor**, quero **pausar e retomar pela equipe**, para **administrar a equipe em um único lugar**.

## Critérios de aceitação
- [ ] A capacidade 'Pausar e retomar pela equipe' pode ser executada no fluxo previsto.
