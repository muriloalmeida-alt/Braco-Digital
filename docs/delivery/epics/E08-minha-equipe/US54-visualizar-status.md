...
## Contexto
Esta história detalha a capacidade **visualizar status**.

## História de usuário
Como **gestor**, quero **visualizar status**, para **administrar a equipe em um único lugar**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar status' pode ser executada no fluxo previsto.
