...
## Contexto
Esta história detalha a capacidade **acessar funcionário**.

## História de usuário
Como **gestor**, quero **acessar funcionário**, para **administrar a equipe em um único lugar**.

## Critérios de aceitação
- [ ] A capacidade 'Acessar funcionário' pode ser executada no fluxo previsto.
