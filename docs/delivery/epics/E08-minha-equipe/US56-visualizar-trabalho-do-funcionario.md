# US56 — Visualizar trabalho do funcionário

**Épico:** E08 — Minha Equipe  
**Prioridade:** P0  
**Sprint planejada:** Sprint 04

## Contexto
Esta história detalha a capacidade **visualizar trabalho do funcionário**.

## História de usuário
Como **gestor**, quero **visualizar trabalho do funcionário**, para **administrar a equipe em um único lugar**.

## Critérios de aceitação
- [ ] A capacidade 'Visualizar trabalho do funcionário' pode ser executada no fluxo previsto.
...
## Regras de negócio
- Minha Equipe é a principal área gerencial.
- Estados e atenção necessária devem ser claros.
...
- `docs/delivery/epics/E08-minha-equipe/epic.md`
