...
## Contexto
Esta história detalha a capacidade **alterar configuração**.

## História de usuário
Como **gestor**, quero **alterar configuração**, para **administrar a equipe em um único lugar**.

## Critérios de aceitação
- [ ] A capacidade 'Alterar configuração' pode ser executada no fluxo previsto.
