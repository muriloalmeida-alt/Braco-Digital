...
## Contexto
Esta história detalha a capacidade **recuperar oportunidade perdida**.

## História de usuário
Como **funcionário digital**, quero **recuperar oportunidade perdida**, para **garantir continuidade e recuperar oportunidades**.

## Critérios de aceitação
- [ ] A capacidade 'Recuperar oportunidade perdida' pode ser executada no fluxo previsto.
