...
## Contexto
Esta história detalha a capacidade **identificar necessidade de follow-up**.

## História de usuário
Como **funcionário digital**, quero **identificar necessidade de follow-up**, para **garantir continuidade e recuperar oportunidades**.

## Critérios de aceitação
- [ ] A capacidade 'Identificar necessidade de follow-up' pode ser executada no fluxo previsto.
