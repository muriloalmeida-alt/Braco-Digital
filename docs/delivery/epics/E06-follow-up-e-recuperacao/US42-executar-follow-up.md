...
## Contexto
Esta história detalha a capacidade **executar follow-up**.

## História de usuário
Como **funcionário digital**, quero **executar follow-up**, para **garantir continuidade e recuperar oportunidades**.

## Critérios de aceitação
- [ ] A capacidade 'Executar follow-up' pode ser executada no fluxo previsto.
