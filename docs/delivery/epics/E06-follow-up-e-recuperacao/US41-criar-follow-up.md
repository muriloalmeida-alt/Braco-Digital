...
## Contexto
Esta história detalha a capacidade **criar follow-up**.

## História de usuário
Como **funcionário digital**, quero **criar follow-up**, para **garantir continuidade e recuperar oportunidades**.

## Critérios de aceitação
- [ ] A capacidade 'Criar follow-up' pode ser executada no fluxo previsto.
