...
## Contexto
Esta história detalha a capacidade **registrar resultado do follow-up**.

## História de usuário
Como **funcionário digital**, quero **registrar resultado do follow-up**, para **garantir continuidade e recuperar oportunidades**.

## Critérios de aceitação
- [ ] A capacidade 'Registrar resultado do follow-up' pode ser executada no fluxo previsto.
